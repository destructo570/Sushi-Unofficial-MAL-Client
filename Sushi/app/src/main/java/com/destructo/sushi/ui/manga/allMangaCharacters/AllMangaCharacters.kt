...
@AndroidEntryPoint
class AllMangaCharacters : Fragment() {

    private lateinit var binding: FragmentAllMangaCharactersBinding
    private val allCharacterViewModel: AllMangaCharacterViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            ...
            mangaIdArg = AllCharactersFragmentArgs.fromBundle(requireArguments()).malId
            allCharacterViewModel.getMangaCharacters(mangaIdArg)
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        allCharacterViewModel.mangaCharacter.observe(viewLifecycleOwner) { resource ->
